...
| If there is no title: <ul><li>Refer back to archival finding aid or file title and extrapolate</li><li>Create one; it must be enclosed in [square brackets] and should be both succinct and descriptive</li></ul> | |
